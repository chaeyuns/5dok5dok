$(document).ready(function () {
    ...
    $(".tab_btn>div:nth-child(1)").click(function () {
        $(".menu_banner").css({ "background-image": "url(images/menu_banner1.gif)" });
    });
    $(".tab_btn>div:nth-child(2)").click(function () {
        $(".menu_banner").css({ "background-image": "url(images/menu_banner2.gif)" });
    });
    $(".tab_btn>div:nth-child(3)").click(function () {
        $(".menu_banner").css({ "background-image": "url(images/menu_banner3.gif)" });
    });
    $("tab_btn>div").click(function () {
        $(".tab_btn").css({ "color": "#fff" });
    });
});